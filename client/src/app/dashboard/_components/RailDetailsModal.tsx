...
import { RailDetailsModalProps, BUTTON_STYLES } from "@/types/dashboard";
          ...
          <div className="flex items-center gap-4">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                <Typography variant="h2" className="text-2xl font-mono">
                  Rail #{rail.id}
                </Typography>
                <motion.div
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <Typography variant="body" className="font-mono text-base">
                      {ethers.formatUnits(
                        rail.paymentRate,
                        token?.decimals || 18
                      )}{" "}
              ...
              <div>
                ...
                >
                  ...
                  <Typography variant="body" className="font-mono text-sm break-all">
                    {rail.token}
                  </Typography>
                </motion.div>
              </div>
